...
public class ProblemController {
	...
	public Result newlist(@PathVariable String labelid,@PathVariable
	...
	public Result hotlist(@PathVariable String labelid,@PathVariable
			int page,@PathVariable int size){
	...
	//等待回答列表
	@RequestMapping(value = "/all/{labelid}/{page}/{size}",method = RequestMethod.GET)
	public Result waitlist(@PathVariable String labelid,@PathVariable
			int page,@PathVariable int size){
